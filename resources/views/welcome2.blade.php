    ...
    <div class="container">
        <div class="row vh-md-100">
            <div class="col-md-8 col-sm-10 col-12 mx-auto my-auto text-center">
                ...
                <p class="lead py-3">With our library management system, you can access a vast collection of books, journals and articles on a wide range of topics. Register and login to start exploring today!</p>
